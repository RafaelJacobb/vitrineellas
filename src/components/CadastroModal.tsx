      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-4 md:inset-auto md:top-6 md:left-0 md:right-0 md:mx-auto md:w-full md:max-w-2xl md:max-h-[85vh] bg-card rounded-2xl shadow-lg z-50 flex flex-col overflow-hidden"
          >
            {/* Header */}
